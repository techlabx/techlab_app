...
const InfoPage = () => (
  <UiWrapper pageTitle='Sobre o Gapsi' lastPage='/'>
    <ContentContainer title={header.title} text={header.text} bgColor={global.Blue} bgImage={bgImg} textColor={global.FontColorDark}>
      <ContactBox/>
    </ContentContainer>
    ...
    <ContentContainer title={theme4.title} text={theme4.text} bgColor={global.Blue}/>
