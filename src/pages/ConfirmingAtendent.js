      ...
      return (    
        <UiWrapper pageTitle="Confirmação da Agenda" lastPage="/Atendents">
          ...
          <div className={styles.ButtonBox}>
            <button className={styles.AddButton} onClick={() => handleSendClick(queryString.parse(location.search).sigla)}>
              ENVIAR
            </button>
          ...
          <div className={styles.CalendarButtonBox}>
            <button
              ...
              onClick={() => handleGenerateLinkClick(queryString.parse(location.search).sigla)}
            >
